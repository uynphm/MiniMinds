    ...
    <main className="flex h-screen flex-col items-center justify-center p-4 sm:p-24 bg-blue-custom text-white overflow-hidden">
      ...
      <div className="mt-8">
        <div className="w-full max-w-4xl text-center space-y-8 relative z-10 animate-bounce-in">
          <h1 className="text-4xl sm:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-950 animate-pulse">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-blue-950 rounded-xl shadow-lg p-8 transform transition-all duration-300 hover:-translate-y-5 hover:shadow-xl mb-3">
          ...
          <Link
            href="/UploadPage"
            className="inline-flex items-center px-6 pt-3 py-3 text-lg font-medium text-white bg-blue-950 rounded-full hover:bg-gray-600 transition-colors duration-300 group"
          >
            Start Detection
